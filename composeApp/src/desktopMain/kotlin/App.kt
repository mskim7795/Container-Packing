...
import view.container.showConditionView
...
fun app() {
    ...
    when (screenStack.last().screen) {
        ...
        Screen.NEW_CONDITION -> showConditionView(screenStack)
    }
}
...
fun topAppBar(screenStack: SnapshotStateList<ScreenView>) {
    ...
    TopAppBar(
        ...
        navigationIcon = { if (currentScreen != Screen.INDEX) goBack(screenStack) }
    )
}
